  ...
  return (
    <>
      <div style={bgImage} id="home"
        className=' min-h-[100vh] w-[screen]
        ...
        <div className='container mt-8 pb-8 sm:pb-0'>
          <div className='grid grid-cols-1 sm:grid-cols-2 '>
            <div className='flex flex-col justify-center gap-5 pt-12 mt-16 sm:pt-0 text-center sm:text-left order-2 sm:order-1'>
              ...
              <h1 className='text-5xl hidden md:block stikey'>{`Excel in packing and baranding with us`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "papper cups", "", "UI/UX Designer" ]'><span className="wrap">{text}</span></span></h1>
...
creativity, redefining packaging excellence.</p>
              <Link to="#contact" smooth className='flex w-40 py-2 items-center gap-2 text-white bg-gradient-to-r  from-[#74D680] to-[#378B29] py-1 px-4 rounded-full  hover:scale-105 duration-200 text-2xl '>Contact
              <img width="40" height="40" src="https://img.icons8.com/plasticine/100/phone.png" alt="phone"/>
              </Link>
            </div>
            <div className='order-1  sm:order-2 relative min-h-[50px] sm:min-h-[450px] flex items-center justify-center '>
              <div>
                <img src={imageId} alt="" className='w-[300px] h-[40vh] p-4 sm:w-[350px] mx-auto spin ' />
              </div>
              <di className='flex lg:flex-col lg:top-1/2 lg:-translate-y-1/2 translate-y-[10vh] lg:py-2 justify-center gap-4 md:h-[20rem] absolute bottom-[0px] lg:-right-10 bg-white/30 rounded-full'>
                {imageList.map((item) => (
